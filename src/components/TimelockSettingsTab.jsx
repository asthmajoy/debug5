        ...
        <>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Critical Threat Delay (seconds)</label>
                <input 
                  type="number" 
                  className="w-full rounded-md border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white p-2" 
                ...
                />
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Current: {formatTime(timelockSettings.criticalThreatDelay)}</p>
              </div>
            </div>
